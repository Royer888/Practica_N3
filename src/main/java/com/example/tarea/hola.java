...
public class hola {
    ...
    public Object getPeliculas(
        ...
        List<Pelicula> lista = Arrays.asList(
                ...
                new Pelicula("Rapidos y Furiosos",
                ...
                new Pelicula("Mi Villano Favorito",
                ...
                new Pelicula("Piratas del Caribe",
                ...
                new Pelicula("Batman Dark Knight",
                        "Descripción: Dirigida por Christopher Nolan, es la segunda entrega de la trilogía de Batman. Bruce Wayne/Batman enfrenta a su mayor amenaza: el Joker, un criminal psicópata y anarquista que busca sembrar el caos en Gotham City, poniendo a prueba los límites morales del héroe, el fiscal Harvey Dent y la sociedad.",
                        "18 de julio de 2008",
                        Arrays.asList("Accion", "Crimen", "Drama", "Suspenso"),
                        152),

                new Pelicula("Lilo & Stitch",
        ...
        List<Pelicula> resultado = lista.stream()
        ...
        if (resultado.isEmpty()) {
            return "No tengo de esas escoge otra";
        }
    ...
    private List<Pelicula> listaPost = new java.util.ArrayList<>();
